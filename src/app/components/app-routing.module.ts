...
const routes: Routes = [
    ...
    { path: "browse", loadChildren: () => import("~/app/modules/browse/browse.module").then(m => m.BrowseModule) },
    { path: "search", loadChildren: () => import("~/app/modules/search/search.module").then(m => m.SearchModule) },
    { path: "featured", loadChildren: () => import("~/app/modules/featured/featured.module").then(m => m.FeaturedModule) },
